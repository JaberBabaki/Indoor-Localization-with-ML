...
def filter_noise(filter_method, file_name):
    ...
    if filter_method == 'kalman_filter':
        ...
        resulted_data.to_csv('output data/BLE_rssi_after_Kalman_Filter_Grid_1.5m_2.5m.csv', index=False)
        ...
        resulted_data.to_csv('output data/BLE_rssi_after_Particle_Filter_Grid_1.5m_2.5m.csv', index=False)
        ...
        resulted_data.to_csv('output data/BLE_rssi_after_Gray_Filter_Grid_1.5m_2.5m.csv', index=False)
        ...
        resulted_data.to_csv('output data/BLE_rssi_after_FFT_Filter_Grid_1.5m_2.5m.csv', index=False)
